...
def scraper(url):
    ...
    try :
        ...
        try:
            ...
            wait.until(EC.presence_of_element_located((By.CLASS_NAME,'rui-eCfYo')))
        ...
        for barang in soup.find_all('div',class_="_1DNjI"):
            
            # Get the text from the specified element and assign them to the variables
            try :
                barang_name = barang.find_all('itemTitle',{'class':"_2poNJ"}).get_text()
